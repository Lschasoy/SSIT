...
public class Ruido {
	...
	private static void uniforme(Image image, double p, int minVal, int maxVal){
		...
		Image ruidosa = Image.crearImagen(image.widthRoi(), image.heightRoi(), image, "Imagen ruidosa de ");
		Image ruido = Image.crearImagen(image.widthRoi(), image.heightRoi(), image, "Imagen de ruido");
		...
		Tracer.insert("Ruido", "ruidosa", ruidosa.img);
		Tracer.insert("Ruido", "ruido", ruido.img);
	}
